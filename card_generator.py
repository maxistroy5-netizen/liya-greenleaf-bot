...
# Personalized invitation PDFs are installed by sitecustomize.py.
# Import it explicitly here because card_generator is always imported by bot.py,
# while Python does not reliably auto-load a project-local sitecustomize on Render.
