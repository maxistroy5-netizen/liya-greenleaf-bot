...
async def chat(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    modes = {
        ...
        "💬 Тренировка диалога": (
            ...
            "Проведи ролевую тренировку. Ты играешь потенциального партнёра "
            "или клиента Greenleaf, а пользователь тренируется вести диалог. "
            "Не подсказывай ответ заранее. После ответа пользователя дай "
            "короткую обратную связь и продолжи диалог."
        ),
